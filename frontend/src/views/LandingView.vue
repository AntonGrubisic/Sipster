<template>
  <div class="page">
    ...
    <nav class="tabs" aria-label="Main menu">
      <router-link class="tab" to="/wines" :class="{ active: isActive('/wine-browser') }">Wines</router-link>
      <router-link class="tab" to="/pairings" :class="{ active: isActive('/culinary-pairings') }">Pairings</router-link>
    </nav>
